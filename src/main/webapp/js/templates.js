...
function program1(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n 	  <div>\n    <div>\n  	  <button class=\"btn\" onclick=\"app.turn('${pg}',-1,'";
  stack1 = depth0.data;
  stack1 = stack1 == null || stack1 === false ? stack1 : stack1.keywords;
  stack1 = typeof stack1 === functionType ? stack1() : stack1;
  buffer += escapeExpression(stack1) + "')\">Prev</button>\n  	  <button class=\"btn\" onclick=\"app.turn('${pg}',1,'";
  stack1 = depth0.data;
  stack1 = stack1 == null || stack1 === false ? stack1 : stack1.keywords;
  stack1 = typeof stack1 === functionType ? stack1() : stack1;
  buffer += escapeExpression(stack1) + "')\">Next</button>\n    </div>\n</div>";
  return buffer;}
);
